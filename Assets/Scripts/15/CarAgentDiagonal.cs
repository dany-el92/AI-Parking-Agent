...
public class CarAgentDiagonal : Agent {
    private CarController carController;
    public CarSpotsManagerDiagonal carSpotsManager;
    ...
    void FixedUpdate() {
        ...
        if(isPositioning && findParkingSpot) { 
            PositionCar(-1.5f); // Posiziona la macchina
        }

        // Se non si sta cercando un posto (fase di addestramento) e ci sono dei target
    ...
    private void Reset() {
        ...
        randomPositionIndex = carSpotsManager.RandomPositionIndex;
